import unittest
from PyLabs_term_4.Lab_2.cached import test_func
from PyLabs_term_4.Lab_2 import n_vector
from PyLabs_term_4.Lab_2 import my_json
import json
from PyLabs_term_4.Lab_2.external_merge_sort import ext_merge_sort
...
class CachedTests(unittest.TestCase):
    ...
    def test_cached_decorator(self):
        self.assertEqual(test_func(8, 7), test_func(8, 7))
        self.assertEqual(test_func(0, 0, named="asd"), test_func(0, 0, named="asd"))
        self.assertEqual(test_func(4, 6, named_2=8456, named="sdfghkj"), test_func(4, 6))
